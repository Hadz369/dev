...
namespace ArduinoUDP.Database
{
	public sealed class ArduinoMySQL
    {
        #region Singleton Initialisation

        private static readonly ArduinoMySQL instance = new ArduinoMySQL();

        private ArduinoMySQL() { }

        public static ArduinoMySQL Instance { get { return instance; } }
