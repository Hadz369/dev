...
namespace Metro
{
    ...
    public class Request
    {
        ...
        [DataMember]
        public PropertyBag PropertyBag { get { return _props; } set { _props = value; } }
        ...
        /// <returns></returns>
        public Dictionary<string, Property> ValidateProperties(Dictionary<string, Property> props)
        {
            foreach (Property p in PropertyBag)
            {
                try 
                {
                    props[p.Name] = p;
                ...
                {
                    throw new InvalidPropertyException(String.Format("Property {0} was not found in the supplied property list", p.Name));
                }
            }
