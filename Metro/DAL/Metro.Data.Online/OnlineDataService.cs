...
{
    public class OnlineDataService : DataServiceBase
    {
        const string KEY = "Online";

        public OnlineDataService() : base(KEY, String.Concat(KEY, " Data Service")) { }

        public override void ThreadProc()
        {
            using (ServiceHost sh = new ServiceHost(typeof(OnlineDataContract),
                new Uri[]{
