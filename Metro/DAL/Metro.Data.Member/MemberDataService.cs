...
{
    public class MemberDataService : DataServiceBase
    {
        const string KEY = "Member";

        public MemberDataService() : base(KEY, String.Concat(KEY, " Data Service")) { }

        public override void ThreadProc()
        {
            using (ServiceHost sh = new ServiceHost(typeof(MemberDataContract),
                new Uri[]{
