...
{
    public class FlexiNetDataService : DataServiceBase
    {
        const string KEY = "FlexiNet";

        public FlexiNetDataService() : base(KEY, String.Concat(KEY, " Data Service")) { }

        public override void ThreadProc()
        {
            using (ServiceHost sh = new ServiceHost(typeof(FlexiNetDataContract),
                new Uri[]{
